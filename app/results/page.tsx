  ...
  return (
    <div className="min-h-screen bg-black text-white">
      ...
      <main className="container mx-auto px-6 py-8">
        ...
        {/* Third Block of Metrics - Simplified Charts for v0 compatibility */}
        <Card className="bg-gray-800 border-gray-700 mb-8">
          <CardHeader>
            <CardTitle className="text-white flex items-center">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="bg-gray-900/50 rounded-lg p-4">
              ...
              <ChartContainer config={phaseQualityChartConfig} className="h-[350px]">
                <BarChart data={phaseQualityData}>
                  <CartesianGrid strokeDasharray="3 3" />
                  <XAxis dataKey="name" tick={{ fill: "#d1d5db", fontSize: 12 }} axisLine={{ stroke: "#374151" }} />
                  <YAxis tick={{ fill: "#d1d5db", fontSize: 12 }} axisLine={{ stroke: "#374151" }} />
                  <ChartTooltip content={<ChartTooltipContent />} cursor={{ fill: "rgba(255, 255, 255, 0.1)" }} />
                  <Bar dataKey="acpl" radius={[4, 4, 0, 0]}>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="bg-gray-900/50 rounded-lg p-4">
                ...
                <ChartContainer config={phaseQualityChartConfig} className="h-[250px]">
                  <PieChart>
                    <Pie
              ...
              <div className="bg-gray-900/50 rounded-lg p-4">
                ...
                <ChartContainer config={blunderChartConfig} className="h-[250px]">
                  <PieChart>
                    <Pie
                      data={blunderData}
                      cx="50%"
